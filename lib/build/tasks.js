...
const publicJsPath = path.join(paths.public, 'javascripts')
const publicCssPath = path.join(paths.public, 'css')
...
function generateAssets () {
  ...
  copyAsset(paths.datePickerLib, publicJsPath, 'datepicker.min.js')
  copyAsset(paths.datePickerLib, publicCssPath, 'datepicker.min.css')
}
...
function copyAsset (sourcePath, targetPath, fileName) {
